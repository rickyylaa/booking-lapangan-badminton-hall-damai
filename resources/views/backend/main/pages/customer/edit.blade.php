    ...
    <div class="row">
        <div class="col-12 mb-4 mb-sm-5">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-dark w-100px rounded-0" data-bs-toggle="modal" data-bs-target="#customerModal">VIEW</button>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <form method="POST" action="{{ route('customer.update', $customer->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row px-xxl-2">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-border-bottom form-control-transparent h6">
                                    <textarea name="address" id="address" class="form-control" rows="3" required>{{ old('address', $customer->address) }}</textarea>
                                </div>
                                <p class="text-danger small">{{ $errors->first('address') }}</p>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center align-items-center mb-0">
                            <a href="{{ route('customer.index') }}" class="btn btn-secondary w-50 rounded-0 mb-0 me-3">BACK</a>
                ...
                <div class="row px-xxl-2">
                    <div class="col-12">
                        <div class="card bg-transparent text-center p-1 w-100">
                            <img src="{{ asset('storage/customers/'. $customer->image) }}" alt="customer" class="rounded-0">
                        </div>
                    </div>
                </div>
            </div>
